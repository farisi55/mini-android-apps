...
public class QuizPageFive extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_page_five);
    }
    //cara pindah halaman
    public void goBack(View v) {
        Intent intent = new Intent(this, QuizPageFour.class);
        finish ();
        this.startActivity(intent);
    }

    public void goNext(View v) {
        Intent intent = new Intent(this, HasilTest.class);
        ...
        Toast.makeText(QuizPageFive.this, "nilai kamu " + jwb,
